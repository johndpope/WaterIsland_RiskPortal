...
$('#ess_new_deal_form').on('submit', function (e) {
    ...
    var bull_thesis_model_file = $('#bull_thesis_model')[0].files[0];
    var our_thesis_model_file = $('#our_thesis_model')[0].files[0];
    var bear_thesis_model_file = $('#bear_thesis_model')[0].files[0];
