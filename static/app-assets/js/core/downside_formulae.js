$(document).ready(function(){
   let downside_table = $('#downside_formulae_table').DataTable({'autoWidth':false});
   ...
   $('#downside_formulae_table tr td .BaseCaseDownsideType').on('change', function(e){
      ...
      if(downside_type_selected === 'Fixed Value'){
      ...
      }else if(downside_type_selected === 'Price * Premium/Discount'){
   ...
   $('#downside_formulae_table tr td button').on('click', function(e){
      ...
      // Make an Ajax POST request...
       console.log(downsides_data_dictionary);
       ...
       $.ajax({
          ...
          "success":function(response){
             if(response === 'Success'){
                //Show success Toastr...
                 toastr.success('Updated BaseCase and Outlier for the deal..', 'Formula Updated!', {"showMethod": "slideDown", "hideMethod": "slideUp", timeOut: 2800});
             }
             else{
                //Failed. Show error toastr
                 toastr.error('Failed updating BaseCase and Outlier for the deal..', 'Error!', {"showMethod": "slideDown", "hideMethod": "slideUp", timeOut: 2800});
             }
          },
          "error":function(err){
             console.log(err);
