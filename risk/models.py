...
class MaDealsActionIdDetails(models.Model):
    """Model for storing the information retrieved from Bloomberg using Action ID"""
    action_id = models.CharField(primary_key=True, null=False, blank=False, max_length=20)
    ...
    target_industry = models.CharField(max_length=100, null=True, blank=True)
    target_country = models.CharField(max_length=100, null=True, blank=True)
    acquirer_name = models.CharField(max_length=100, null=True, blank=True)
    acquirer_ticker = models.CharField(max_length=100, null=True, blank=True)
    acquirer_industry = models.CharField(max_length=100, null=True, blank=True)
    acquirer_country = models.CharField(max_length=100, null=True, blank=True)
    ...
    nature_of_bid = models.CharField(max_length=100, null=True, blank=True)
    ...
    mergers_agreement_date = models.DateField(null=True, blank=True)
    expected_completion_date = models.DateField(null=True, blank=True)
    drop_dead_date = models.DateField(null=True, blank=True)
    go_shop_period_end_date = models.DateField(null=True, blank=True)
    termination_date = models.DateField(null=True, blank=True)
    net_debt = models.CharField(max_length=200, null=True, blank=True)
    ebitda_total_tvm = models.CharField(max_length=200, null=True, blank=True)
    ebit_total_tvm = models.CharField(max_length=200, null=True, blank=True)
    revenue_total_tvm = models.CharField(max_length=200, null=True, blank=True)
    total_assets_total_tvm = models.CharField(max_length=200, null=True, blank=True)
    free_cashflow_total_tvm = models.CharField(max_length=200, null=True, blank=True)
    ebitda_equity_tvm = models.CharField(max_length=200, null=True, blank=True)
    ebit_equity_tvm = models.CharField(max_length=200, null=True, blank=True)
    revenue_equity_tvm = models.CharField(max_length=200, null=True, blank=True)
    total_assets_equity_tvm = models.CharField(max_length=200, null=True, blank=True)
    free_cashflow_equity_tvm = models.CharField(max_length=200, null=True, blank=True)
    deal_currency = models.CharField(max_length=50, null=True, blank=True)
    payment_type = models.CharField(max_length=50, null=True, blank=True)
    cash_terms = models.CharField(max_length=200, null=True, blank=True)
    stock_terms = models.CharField(max_length=200, null=True, blank=True)
    percent_owned = models.CharField(max_length=200, null=True, blank=True)
    percent_sought = models.CharField(max_length=200, null=True, blank=True)
    announced_total_value = models.CharField(max_length=200, null=True, blank=True)
    announced_premium = models.CharField(max_length=200, null=True, blank=True)
    target_to_acquirer_termination_fees = models.CharField(max_length=200, null=True, blank=True)
    acquirer_to_target_termination_fess = models.CharField(max_length=200, null=True, blank=True)
    pending_approvals = models.CharField(max_length=200, null=True, blank=True)
    expired_approvals = models.CharField(max_length=200, null=True, blank=True)
    approved_approvals = models.CharField(max_length=200, null=True, blank=True)
    extended_approvals = models.CharField(max_length=200, null=True, blank=True)
    blocked_approvals = models.CharField(max_length=200, null=True, blank=True)
    early_termination_approvals = models.CharField(max_length=200, null=True, blank=True)
