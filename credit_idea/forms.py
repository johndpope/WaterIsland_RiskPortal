...
class CreditIdeaForm(forms.ModelForm):
    ...
    class Meta:
        model = CreditIdea
        fields = ['analyst', 'arb_tradegroup', 'deal_bucket', 'deal_strategy_type', 'catalyst',
                  'catalyst_tier', 'target_sec_cusip', 'coupon', 'hedge_sec_cusip', 'estimated_closing_date',
                  'upside_price', 'downside_price', 'comments']
        labels = {
            "analyst": "Analyst",
        ...
        widgets = {
            ...
            "target_sec_cusip": forms.TextInput(attrs={'class': FORM_CONTROL_CLASS, 'label_class': BADGE_SUCCESS_CLASS,
                                                       'id': 'target_sec_cusip', 'required': True}),
            ...
            "hedge_sec_cusip": forms.TextInput(attrs={'class': FORM_CONTROL_CLASS, 'label_class': BADGE_SUCCESS_CLASS,
                                                      'id': 'hedge_sec_cusip', 'required': True}),
            ...
            "comments": forms.Textarea(attrs={'class': FORM_CONTROL_CLASS, 'label_class': BADGE_SUCCESS_CLASS,
                                              'id': 'comments', 'rows': 8, 'cols': 40, 'required': False}),
        }
